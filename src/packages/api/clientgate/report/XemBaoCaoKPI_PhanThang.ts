...
export const useXemBaoCaoKPI_PhanThangApi = (apiBase: AxiosInstance) => {
  apiBase.defaults.headers["DealerCode"] = "HTV";
  return {
    XemBaoCaoKPI_PhanThang_SearchHQ: async (params: any): Promise<any> => {
      const request = {
        ...params,
    ...
    XemBaoCaoKPI_PhanThang_SearchDL: async (params: any): Promise<any> => {
      // fake response data
    ...
    // Get all DealerCode
    XemBaoCaoKPI_PhanThang_GetAllActive: async (): Promise<
