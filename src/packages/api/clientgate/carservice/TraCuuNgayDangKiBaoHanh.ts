...
export const useTraCuuNgayDangKiBaoHanhApi = (apiBase: AxiosInstance) => {
  apiBase.defaults.headers["DealerCode"] = "HTV";
  return {
    TraCuuNgayDangKiBaoHanh_SearchHQ: async (params: any): Promise<any> => {
      const request = {
        ...params,
    ...
    TraCuuNgayDangKiBaoHanh_SearchDL: async (params: any): Promise<any> => {
      // fake response data
    ...
    // Get all DealerCode
    TraCuuNgayDangKiBaoHanh_GetAllActive: async (): Promise<
