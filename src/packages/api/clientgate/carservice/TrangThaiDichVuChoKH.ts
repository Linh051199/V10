...
export const useTrangThaiDichVuKHApi = (apiBase: AxiosInstance) => {
  apiBase.defaults.headers["DealerCode"] = "HTV";
  return {
    TrangThaiDichVuKH_SearchHQ: async (params: any): Promise<any> => {
      const request = {
        ...params,
    ...
    TrangThaiDichVuKH_SearchDL: async (params: any): Promise<any> => {
      // fake response data
    ...
    // Get all DealerCode
    TrangThaiDichVuKH_GetAllActive: async (): Promise<
