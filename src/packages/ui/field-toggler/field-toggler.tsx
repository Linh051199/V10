...
export default function FieldToggler(props: FieldTogglerProps) {
  const {
    container,
    button,
    visible,
  ...
  const handleChangeOrder = ({
    ...
    console.log("111: changes after re-order:", changes);
  ...
  return (
    ...
    >
      ...
      <div className={"w-full flex flex-row max-h-[400px] gap-3"}>
        <ScrollView
          className={"flex-1"}
          height={350}
