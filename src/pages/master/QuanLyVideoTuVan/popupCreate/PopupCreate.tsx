...
const PopupCreateVideoTuVan = forwardRef(
  ({ visible, orderListRef, onCancel, gridViewOneRef, fetchData, BOMCode, onRefetch }: IProps, ref: any) => {
    ...
    const onHiding = () => {
      setValue("FilePathVideoCode", "")
      setValue("FilePathVideoName", "")
      setValue("FilePathVideo", "")
      setValue("FilePathAvatar", "")
      setValue("IdxView", "")
      setValue("FlagActive", "")
    }
    ...
    const onSubmit = async (data: any) => {
      ...
      const response = await api.Ser_Mst_FilePathVideoApi_Create(condition)
...
export default PopupCreateVideoTuVan;
