...
export interface QuanLyVideoTuVan_PopupViewProps {
  onEdit: (rowIndex: number) => void;
  formSettings: FormOptions;
}

export const QuanLyVideoTuVan_PopupView = ({
  onEdit,
  formSettings,
}: QuanLyVideoTuVan_PopupViewProps) => {
  ...
  return (
    <PopupView
      ...
      title={t("QuanLyVideoTuVan_PopupView")}
