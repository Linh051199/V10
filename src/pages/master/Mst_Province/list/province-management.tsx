...
import { HeaderPart } from "src/pages/master/Mst_Province/list/header-part";
import "src/pages/master/Mst_Province/list/province-management.scss";
      ...
      <AdminContentLayout.Slot name={"Header"}>
        <PageHeaderLayout>
          <PageHeaderLayout.Slot name={"Before"}>
            <div className="page-title">{t("ProvinceManagement")}</div>
