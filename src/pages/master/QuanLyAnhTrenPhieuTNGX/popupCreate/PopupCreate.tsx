...
const PopupCreateQuanLyAnhTranPhieuTNGX = forwardRef(
  ({ visible, orderListRef, onCancel, gridViewOneRef, fetchData, BOMCode, onRefetch, modelList, receptionList }: IProps, ref: any) => {
    const { t } = useI18n("CreateQuanLyAnhTranPhieuTNGX");
    ...
    const onSubmit = async (data: any) => {
      ...
      const response = await api.Ser_Mst_ModelAudImageApi_Create(condition)
    ...
    return (
      <div>
        <Popup
          ...
          title={t("CreateQuanLyAnhTranPhieuTNGX")}
                              ...
                              render={({ field }) => {
                                return (
                                  <SelectBoxField
                                    ...
                                    dataSource={receptionList ?? []}
                                    displayExpr={(e: any) => {
                                      return e?.ReceptionFAudType && `${e?.ReceptionFAudType} - ${e?.ReceptionFAudTypeName}`
                                    }}
                                    valueExpr="ReceptionFAudType"
                                  />
                                );
                              }}
                            />
...
export default PopupCreateQuanLyAnhTranPhieuTNGX;
