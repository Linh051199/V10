...
export const openPopupWarningDuplicateForServiceAtom = atom<boolean>(false);

export const WarningDuplicateForService = ({
  visible,
  message = "Duplicate",
  typeIcon = "warning",
}: {
  ...
  const [open, setOpen] = useAtom(openPopupWarningDuplicateForServiceAtom);
