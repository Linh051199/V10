...
export const Ser_MST_ROWorkArisingPage = () => {
  const { t } = useI18n("Ser_MST_ROWorkArising");
  ...
  const columns = [
    ...
    {
      dataField: "GiaBanToiDa",
      caption: t("GiaBanToiDa"),
      editorType: "dxTextBox",
      width: 200,
      visible: true,
      editorOptions: {
            ...
            {!loadingControl.visible && (
              <>
                <GridViewOne
                  ...
                  keyExpr={"VIN"}
                  storeKey={"Ser_MST_ROWorkArising-management-columns"}
                />
                {/* <DealerPopupView
                        onEdit={handleEdit}
