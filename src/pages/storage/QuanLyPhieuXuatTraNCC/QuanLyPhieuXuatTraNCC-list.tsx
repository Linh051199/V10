...
const QuanLyPhieuXuatTraNCCManagementPage = () => {
  ...
  const handleAddNew = () => {
    navigate("/storage/QuanLyPhieuXuatTraNCC/new");
  ...
  const columns = [
    ...
    {
      dataField: "SoPhieuXuat",
      visible: true,
      caption: t("SoPhieuXuat"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    {
      dataField: "NgayXuatKho",
      visible: true,
      caption: t("NgayXuatKho"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    <AdminContentLayout className={"delivery-order-list"}>
      <AdminContentLayout.Slot name={"Header"}>
        <div className="flex justify-between items-center w-full h-[55px] pl-2">
          <div className="page-title">{t("QuanLyPhieuXuatTraNCC")}</div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <ScrollView height={windowSize.height - 120}>
              ...
              <GridViewOne
                ...
                keyExpr={"MaPhuTung"}
                storeKey={"QuanLyPhieuXuatTraNCC-manager-list"}
              />
            </ScrollView>
          </ContentSearchPanelLayout.Slot>
        </ContentSearchPanelLayout>
...
export default QuanLyPhieuXuatTraNCCManagementPage;
