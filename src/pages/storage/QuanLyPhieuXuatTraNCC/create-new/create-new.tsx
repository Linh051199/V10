...
import { QueryNames } from "../QuanLyPhieuXuatTraNCC-common";
import { useWindowSize } from "@/packages/hooks/useWindowSize";
import { Supplies } from "./car-list";
...
export const QuanLyPhieuXuatTraNCCCreateNew = () => {
  const { t } = useI18n("QuanLyPhieuXuatTraNCC");
  const navigate = useNavigate();
