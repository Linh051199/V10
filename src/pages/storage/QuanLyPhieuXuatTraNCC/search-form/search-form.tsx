...
const SearchForm = ({ data, onSearch }: SearchFormProps) => {
  ...
  const searchFields: any[] = [
    {
      visible: true,
      dataField: "SoPhieuTraHang",
      label: {
        text: t("SoPhieuTraHang"),
      },
    ...
    {
      visible: true,
      dataField: "NgayXuatKhoFromTo",
      label: {
        text: t("NgayXuatKhoFromTo"),
      },
      render: (param: any) => {
        const { dataField, component: formComponent } = param;
        const formData = formComponent.option("formData");
        ...
        return (
          <div className={"flex flex-row "}>
            <SelectField
              ...
              placeholder={t("Input")} items={undefined} />
          </div>
        );
      },
    },
