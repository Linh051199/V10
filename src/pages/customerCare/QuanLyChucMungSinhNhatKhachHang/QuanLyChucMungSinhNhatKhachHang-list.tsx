...
import { useNetworkNavigate, useStateRestore, useVisibilityControl } from "@/packages/hooks";
import { useWindowSize } from "@/packages/hooks/useWindowSize";
import { AdminContentLayout } from "@/packages/layouts/admin-content-layout";
import { ContentSearchPanelLayout } from "@/packages/layouts/content-searchpanel-layout";
import { DataGrid, Form, LoadPanel, Popup, ScrollView } from "devextreme-react";
...
import CapNhatTinhTrangLienHe from "./CapNhatTinhTrangLienHe/CapNhatTinhTrangLienHe";
...
const QuanLyChucMungSinhNhatKhachHangPage = () => {
  const { t } = useI18n("QuanLyChucMungSinhNhatKhachHang");
  ...
  useImperativeHandle(refSearchCar, () => ({
    getGridRef() {
      return gridRef;
    },
    openSearchCar() {
  ...
  const subGridToolbars: ToolbarItemProps[] = [
    ...
    },
    {
      ...
      render: () => {
        return (
          <BButton label={t("Cancel")} onClick={() => { }} />
        );
      },
    },
    {
  ...
  const columns = [
    ...
    {
      dataField: "NgaySinhNhat",
      visible: true,
      caption: t("NgaySinhNhat"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    <AdminContentLayout className={"delivery-order-list"}>
      <AdminContentLayout.Slot name={"Header"}>
        <div className="flex justify-between items-center w-full h-[55px] pl-2">
          <div className="page-title">{t("QuanLyChucMungSinhNhatKhachHang")}</div>
        </div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <ScrollView height={"100%"}>
              ...
              <GridViewOne
                ...
                keyExpr={"TenKhach"}
                storeKey={"QuanLyChucMungSinhNhatKhachHang-manager-list"}
              />

              <CapNhatTinhTrangLienHe
                // dataRef={DataRef}
                ref={refSearchCar}
                visible={false}
...
export default QuanLyChucMungSinhNhatKhachHangPage;
