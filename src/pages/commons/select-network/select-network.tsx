...
export const SelectNetworkPage = () => {
  ...
  const reLogin = () => {
    Promise.resolve()
      ...
      .then(() => {
        window.open(
          `${ssoDomain}/OAuth/Authorize?client_id=${client_id}&redirect_uri=${encodeURI(
            redirectUri
  ...
  return (
    <>
      {list?.length > 1 && (
        <section className="h-full w-full">
          <div
            ...
            style={{
              backgroundImage: `url(https://files01.danhgiaxe.com/1t6DEK9ATSnYp-gmU7V7nnpYuR4=/fit-in/1280x0/20210602/batch_hyundai-santa-fe-2021--2-000608.jpg)`,
              backgroundPosition: "50% 50%",
              backgroundRepeat: "no-repeat",
              backgroundSize: "cover",
            }}
          >
            <div className="bg-white w-[50%] h-[50%] rounded-[13px] shadow-2xl flex items-center flex-col p-[10px] gap-[10px]">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
      ...
      <Popup visible={open} width={500} height={200} title="Chọn network">
        <div className="text-[16px] font-semibold">
          Lấy thông tin network thất bại. Vui lòng đăng nhập lại!
        </div>
        <ToolbarItem
          widget="dxButton"
          toolbar="bottom"
