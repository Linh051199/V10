...
export const Rpt_Ability_Supply_PartsDLPage = () => {
  ...
  const handleExport = async () => {
    const response = await api.Rpt_Ability_Supply_Parts_ExportSearchDL({
  ...
  const fetchData = async () => {
    const resp = await api.Rpt_Ability_Supply_Parts_SearchDL({
      PeriodMonth: searchCondition.current.PeriodMonth
        ? format(searchCondition.current.PeriodMonth, "yyyy-MM-dd")
        : "",
      PartCode: searchCondition.current.PartCode ?? "",
