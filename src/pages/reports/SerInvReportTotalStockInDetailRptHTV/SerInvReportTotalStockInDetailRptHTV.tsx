...
export const SerInvReportTotalStockInDetailRptHTVPage = () => {
  ...
  const handlePrint = async () => {
    const crData = gridRef?.current?.getData();
    if (crData && crData?.length > 0) {
      const response = await api.SerInvReportTotalStockInDetailRpt_PrintHQ({
        FromDate: searchCondition.current.FromDateFromTo[0]
          ? format(
              searchCondition.current.FromDateFromTo[0] as Date,
              "yyyy-MM-dd"
        ...
        <ContentSearchPanelLayout>
          <ContentSearchPanelLayout.Slot name={"SearchPanel"}>
            <div className={"w-[300px] h-full"}>
              <SearchPanelV2
                ...
                storeKey={"SerInvReportTotalStockInDetailRptHTV-search"}
              />
            </div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <GridViewOne
              ...
              isHidenHeaderFilter
              customToolbarItems={[]}
              storeKey={"SerInvReportTotalStockInDetailRptHTV-columns"}
              editMode={false}
