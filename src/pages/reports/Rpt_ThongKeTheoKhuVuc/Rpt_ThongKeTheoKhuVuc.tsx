...
// import { ResultReport } from "@/pages/reports/Rpt_ThongKeTheoKhuVuc/components/result";
import { searchConditionAtom } from "./components/store";
import { ResultReport } from "./components/result";

export const Rpt_ThongKeTheoKhuVucPage = () => {
  const { t } = useI18n("Rpt_ThongKeTheoKhuVuc");
  ...
  const handleExportExcel = useCallback(async () => {
    ...
    //   .with("A", async () => {
    //     return await api.Rpt_ThongKeTheoKhuVuc_ExportSearchTypeAreaHQ({
    ...
    //   })
    //   .otherwise(async () => {
    //     return await api.Rpt_ThongKeTheoKhuVuc_ExportSearchTypeDealerDL({
    //       SMType: searchCondition.SMType,
    //       FlagDataWH: searchCondition.FlagDataWH,
    //       HRMonthFrom: searchCondition.HRMonthFromTo[0],
    //       HRMonthTo: searchCondition.HRMonthFromTo[1],
  ...
  return (
    <AdminContentLayout className={"province-management"}>
      <AdminContentLayout.Slot name={"Header"}>
        <ReportPageHeader title={t("Rpt_ThongKeTheoKhuVuc")} />
