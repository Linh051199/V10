...
export const Rpt_KhaNangCungUngPhuTungDLKHPage = () => {
  const { t } = useI18n("Rpt_KhaNangCungUngPhuTungDL-KH");
  ...
  const fetchData = async () => {
    // const response = await api.Rpt_KhaNangCungUngPhuTungDL-KH_SearchHQ({
    ...
    //   return {
    //     ...response,
    //     DataList: response?.Data?.Lst_Rpt_KhaNangCungUngPhuTungDL-KH?.map(
    //       (item: any, index: any) => {
    //         return {
    //           ...item,
    //         };
  ...
  const handleExport = async () => {
    ...
    //   const result = await api.Rpt_KhaNangCungUngPhuTungDL-KH_ExportSearchHQ({
    //     VinNo: searchCondition.current.VinNo ?? "",
    //     DateFrom: searchCondition.current.DateFromTo[0]
    //       ? format(searchCondition.current.DateFromTo[0], "yyyy-MM-dd")
    //       : "",
        ...
        <ContentSearchPanelLayout>
          <ContentSearchPanelLayout.Slot name={"SearchPanel"}>
            <div className={"w-[300px] h-full"}>
              <SearchPanelV2
                ...
                storeKey={"Rpt_KhaNangCungUngPhuTungDL-KH-search"}
              />
            </div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            ...
            <GridViewOne
              ...
              isLoading={false}
              customToolbarItems={[]}
              storeKey={"Rpt_KhaNangCungUngPhuTungDL-KH-colums"}
              editMode={false}
