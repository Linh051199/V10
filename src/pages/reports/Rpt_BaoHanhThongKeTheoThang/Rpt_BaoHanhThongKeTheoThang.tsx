...
// import { ResultReport } from "@/pages/reports/Rpt_BaoHanhThongKeTheoThang/components/result";
import { searchConditionAtom } from "./components/store";
import { ResultReport } from "./components/result";

export const Rpt_BaoHanhThongKeTheoThangPage = () => {
  const { t } = useI18n("Rpt_BaoHanhThongKeTheoThang");
  ...
  const handleExportExcel = useCallback(async () => {
    ...
    //   .with("A", async () => {
    //     return await api.Rpt_BaoHanhThongKeTheoThang_ExportSearchTypeAreaHQ({
    ...
    //   })
    //   .otherwise(async () => {
    //     return await api.Rpt_BaoHanhThongKeTheoThang_ExportSearchTypeDealerDL({
    //       SMType: searchCondition.SMType,
    //       FlagDataWH: searchCondition.FlagDataWH,
    //       HRMonthFrom: searchCondition.HRMonthFromTo[0],
    //       HRMonthTo: searchCondition.HRMonthFromTo[1],
  ...
  return (
    <AdminContentLayout className={"province-management"}>
      <AdminContentLayout.Slot name={"Header"}>
        <ReportPageHeader title={t("RptSalesMan")} />
