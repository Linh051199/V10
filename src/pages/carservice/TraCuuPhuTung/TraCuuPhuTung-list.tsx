...
const TraCuuPhuTungManagementPage = () => {
  const { t } = useI18n("TraCuuPhuTung");
  ...
  const columns = [
    ...
    {
      dataField: "MaPhuTungVatTu",
      visible: true,
      caption: t("MaPhuTungVatTu"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    {
      dataField: "GiaNiemYet",
      visible: true,
      caption: t("GiaNiemYet"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    {
      dataField: "GiaBaoHanh",
      visible: true,
      caption: t("GiaBaoHanh"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    {
      dataField: "TonKhoDongAnh",
      visible: true,
      caption: t("TonKhoDongAnh"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    {
      dataField: "TonKhoCaiMep",
      visible: true,
      caption: t("TonKhoCaiMep"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    <AdminContentLayout className={"delivery-order-list"}>
      <AdminContentLayout.Slot name={"Header"}>
        <div className="flex justify-between items-center w-full h-[55px] pl-2">
          <div className="page-title">{t("TraCuuPhuTung")}</div>
        </div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <ScrollView height={"100%"}>
              ...
              <GridViewOne
                ...
                keyExpr={"MaDaiLy"}
                storeKey={"TraCuuPhuTung-manager-list"}
              />
            </ScrollView>
          </ContentSearchPanelLayout.Slot>
        </ContentSearchPanelLayout>
...
export default TraCuuPhuTungManagementPage;
