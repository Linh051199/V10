...
import { data_XemXetBaoCaoBaoHanh } from "../components/data";
...
import { XemXetBaoCaoBaoHanh_PopupView } from "../components/use-popup-view";

export const XemXetBaoCaoBaoHanhPage = () => {
  ...
  const searchCondition = useRef<Partial<Search_XemXetBaoCaoBaoHanh_Param>>({
  ...
  const fetchData = async () => {
    ...
    return {
      DataList: data_XemXetBaoCaoBaoHanh,
  ...
  const onModify = async (id: string, data: XemXetBaoCaoBaoHanh) => {
  ...
  const onCreate = async (data: XemXetBaoCaoBaoHanh & { __KEY__: string }) => {
  ...
  const searchConditions: IItemProps[] = [
    ...
    {
      caption: t("ChiTietBCBH"),
      dataField: "ChiTietBCBH",
      editorType: "dxSelectBox",
      visible: true,
      editorOptions: {
        placeholder: t("Input"),
              ...
              children={
                <div className={"w-[300px]"}>
                  <SearchPanelV2
                    ...
                    storeKey={"XemXetBaoCaoBaoHanh-search-panel"}
                  />
                </div>
              }
            />
            ...
            {!loadingControl.visible && (
              <>
                <GridViewOne
                  ...
                  keyExpr={"SoBCBH"}
                  storeKey={"XemXetBaoCaoBaoHanh"}
                  enablePaging="yes"
                />
                <XemXetBaoCaoBaoHanh_PopupView
                  onEdit={handleEdit}
