...
import { HeaderFormEdit } from "./header-form-view";
...
const QuanLyDeNghiCungCapGiaView = () => {
  const paramUrl = useParams();
  const { t } = useI18n("QuanLyDeNghiCungCapGia_View");
...
export default QuanLyDeNghiCungCapGiaView;
