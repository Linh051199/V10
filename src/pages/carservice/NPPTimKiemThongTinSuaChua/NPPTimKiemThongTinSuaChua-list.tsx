...
const NPPTimKiemThongTinSuaChuaManagementPage = () => {
  const { t } = useI18n("NPPTimKiemThongTinSuaChua");
    ...
    <AdminContentLayout className={"delivery-order-list"}>
      <AdminContentLayout.Slot name={"Header"}>
        <div className="flex justify-between items-center w-full h-[55px] pl-2">
          <div className="page-title">{t("NPPTimKiemThongTinSuaChua")}</div>
        </div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <ScrollView height={"100%"}>
              ...
              <GridViewOne
                ...
                keyExpr={"SoBaoGia"}
                storeKey={"NPPTimKiemThongTinSuaChua-manager-list"}
              />
            </ScrollView>
          </ContentSearchPanelLayout.Slot>
        </ContentSearchPanelLayout>
...
export default NPPTimKiemThongTinSuaChuaManagementPage;
