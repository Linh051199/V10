...
export const QuanLyChamSocKhachHang24hPage = () => {
  ...
  const fetchData = async () => {
    ...
    const data = {
      TenKH: "Testing Đấy",
      DienThoai: "Testing Đấy",
      DiDong: "Testing Đấy",
      BienSo: "Testing Đấy",
      SoKhung: "Testing Đấy",
      HieuXe: "Testing Đấy",
      Model: "Testing Đấy",
      LenhSuaChua: "Testing Đấy",
      NguoiLienLac: "Testing Đấy",
      DiaChiNguoiLienLac: "Testing Đấy",
      EmailNguoiLienLac: "Testing Đấy",
      DienThoaiNguoiLienLac: "Testing Đấy",
      NgayGiaoXe: "Testing Đấy",
      TinhTrang: "Testing Đấy",
    };
              ...
              children={
                <div className={"w-[300px]"}>
                  <SearchPanelV2
                    ...
                    storeKey={"QuanLyChamSocKhachHang24h-search-panel"}
                  />
                </div>
              }
            />
            ...
            {!loadingControl.visible && (
              <>
                <GridViewOne
                  ...
                  storeKey={"QuanLyChamSocKhachHang24h"}
                />
                <TabComponent />
              </>
            )}
