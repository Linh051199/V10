...
const QuanLyYeuCauXuatKhoManagementPage = () => {
      ...
      render: () => {
        return (
          <BButton label={t("TaoPhieuNhap")} onClick={() => {
            navigate(`/service/QuanLyYeuCauXuatKho/new`);
          }} />
        );
      },
    },
  ...
  const columns = [
    ...
    },
    {
      ...
      visible: true,
      caption: t("SoPhieuYeuCauXuat"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    {
      dataField: "NgayYeuCauXuat",
      visible: true,
      caption: t("NgayYeuCauXuat"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    <AdminContentLayout className={"delivery-order-list"}>
      <AdminContentLayout.Slot name={"Header"}>
        <div className="flex justify-between items-center w-full h-[55px] pl-2">
          <div className="page-title">{t("QuanLyYeuCauXuatKho")}</div>
        </div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <ScrollView height={"100%"}>
              ...
              <GridViewOne
                ...
                keyExpr={"SoPhieuYeuCauXuat"}
                storeKey={"QuanLyYeuCauXuatKho-manager-list"}
              />
            </ScrollView>
          </ContentSearchPanelLayout.Slot>
        </ContentSearchPanelLayout>
...
export default QuanLyYeuCauXuatKhoManagementPage;
