...
DaTaoPhieuXuat: 1,
  ...
  const searchFields: any[] = [
    {
      visible: true,
      dataField: "SoPhieuYeuCauXuat",
      label: {
        text: t("SoPhieuYeuCauXuat"),
      },
      render: (param: any) => {
    ...
    {
      dataField: "NgayYeuCauXuatFromTo",
      caption: t("NgayYeuCauXuatFromTo"),
      visible: true,
      ...
      render: (param: any) => {
        ...
        return (
          <div className={"flex flex-col list-checkbox"}>
            ...
            />
            <CheckboxField
              label={t("DaTaoPhieuXuat")}
              dataField={"DaTaoPhieuXuat"}
              formInstance={formComponent}
              defaultValue={formData?.["DaTaoPhieuXuat"] == 1 ? true : false}
              onValueChanged={(e: any) => {
                formComponent.updateData("DaTaoPhieuXuat", e.value);
              }}
            />
            <CheckboxField
              label={t("DaHuy")}
