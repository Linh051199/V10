...
export const QuanLyBanTinKyThuatDetailView = () => {
  const { t } = useI18n("QuanLyBanTinKyThuat");
    ...
    <AdminContentLayout>
      ...
      <AdminContentLayout.Slot name="Content">
        ...
        <ScrollView height={windowSize.height - 120}>
          ...
          />
          <div>
          * Số Vin sai định danh tô màu đỏ<br></br>
            * Số Vin trùng nhau được tô vàng
          </div>
