...
import { QueryNames } from "../QuanLyDatHangKhoToiUu-common";
...
export const QuanLyDatHangTonKhoToiUuCreateNew = () => {
  const { t } = useI18n("QuanLyDatHangTonKhoToiUu");
  const navigate = useNavigate();
