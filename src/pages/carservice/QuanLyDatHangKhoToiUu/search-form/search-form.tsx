...
const SearchForm = ({ data, onSearch }: SearchFormProps) => {
  const { t } = useI18n("QuanLyDatHangKhoToiUu");
  ...
  const searchFields: any[] = [
    {
      dataField: "ChuKyDathang",
      caption: t("ChuKyDathang"),
      visible: true,
      label: {
        visible: false,
        text: t("ChuKyDathang"),
          ...
          <div className={"flex flex-row"}>
            <NumberBox
              ...
              onValueChanged={(e: any) => {
                formComponent.updateData("ChuKyDathang", e.value);
              }}
            />
          </div>
        );
    ...
    {
      dataField: "ThoiGianDuPhong",
      caption: t("ThoiGianDuPhong"),
      visible: true,
      label: {
        visible: false,
        text: t("ThoiGianDuPhong"),
      },
      render: (param: any) => {
        const { dataField, component: formComponent } = param;
        const formData = formComponent.option("formData");
        return (
          <div className={"flex flex-row"}>
            <NumberBox
              ...
              defaultValue={0}
              onValueChanged={(e: any) => {
                formComponent.updateData("ThoiGianDuPhong", e.value);
              }}
            />
          </div>
        );
    ...
    {
      dataField: "ThoiGianHangVeA",
      caption: t("ThoiGianHangVeA"),
      visible: true,
      label: {
        visible: false,
        text: t("ThoiGianHangVeA"),
      },
      render: (param: any) => {
        const { dataField, component: formComponent } = param;
        const formData = formComponent.option("formData");
        return (
          <div className={"flex flex-row"}>
            <NumberBox
              ...
              defaultValue={0}
              onValueChanged={(e: any) => {
                formComponent.updateData("ThoiGianHangVeA", e.value);
              }}
            />
          </div>
        );
    ...
    {
      dataField: "ThoiGianHangVeB",
      caption: t("ThoiGianHangVeB"),
      visible: true,
      label: {
        visible: false,
        text: t("ThoiGianHangVeB"),
      },
      render: (param: any) => {
        const { dataField, component: formComponent } = param;
        const formData = formComponent.option("formData");
        return (
          <div className={"flex flex-row"}>
            <NumberBox
              ...
              defaultValue={0}
              onValueChanged={(e: any) => {
                formComponent.updateData("ThoiGianHangVeB", e.value);
              }}
            />
          </div>
        );
    ...
    {
      dataField: "ThoiGianHangVeC",
      caption: t("ThoiGianHangVeC"),
      visible: true,
      label: {
        visible: false,
        text: t("ThoiGianHangVeC"),
      },
      render: (param: any) => {
        const { dataField, component: formComponent } = param;
        const formData = formComponent.option("formData");
        return (
          <div className={"flex flex-row"}>
            <NumberBox
              ...
              defaultValue={0}
              onValueChanged={(e: any) => {
                formComponent.updateData("ThoiGianHangVeC", e.value);
              }}
            />
          </div>
        );
    ...
    {
      dataField: "ThoiGianHangVeD",
      caption: t("ThoiGianHangVeD"),
      visible: true,
      label: {
        visible: false,
        text: t("ThoiGianHangVeD"),
      },
      render: (param: any) => {
        const { dataField, component: formComponent } = param;
        const formData = formComponent.option("formData");
        return (
          <div className={"flex flex-row"}>
            <NumberBox
              ...
              defaultValue={0}
              onValueChanged={(e: any) => {
                formComponent.updateData("ThoiGianHangVeD", e.value);
              }}
            />
          </div>
        );
