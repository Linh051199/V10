...
const TimKiemBaoGiaPhuTungManagementPage = () => {
  const { t } = useI18n("TimKiemBaoGiaPhuTung");
  ...
  const columns = [
    ...
    {
      dataField: "GiaTriBaoGia",
      visible: true,
      caption: t("GiaTriBaoGia"),
      width: 200,
      minWidth: 200,
      alignment: "center" as Alignment,
    },
    ...
    <AdminContentLayout className={"delivery-order-list"}>
      <AdminContentLayout.Slot name={"Header"}>
        <div className="flex justify-between items-center w-full h-[55px] pl-2">
          <div className="page-title">{t("TimKiemBaoGiaPhuTung")}</div>
        </div>
          ...
          <ContentSearchPanelLayout.Slot name={"ContentPanel"}>
            <ScrollView height={"100%"}>
              ...
              <GridViewOne
                ...
                keyExpr={"SoBaoGia"}
                storeKey={"TimKiemBaoGiaPhuTung-manager-list"}
              />
            </ScrollView>
          </ContentSearchPanelLayout.Slot>
        </ContentSearchPanelLayout>
...
export default TimKiemBaoGiaPhuTungManagementPage;
